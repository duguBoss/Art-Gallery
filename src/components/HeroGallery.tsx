    ...
    <section className="bg-white border-b border-gray-200 py-6 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-1 text-left">
          <div className="inline-block text-[11px] font-mono font-semibold px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-600 border border-blue-100">
            {currentView === 'image-lab' ? 'IMAGE PROMPT LAB · 提示词工程' : 'MOTION PIPELINE · 分步影视工作流'}
          </div>
          <h1 className="text-2xl sm:text-3xl font-sans font-black tracking-tight text-gray-900">
